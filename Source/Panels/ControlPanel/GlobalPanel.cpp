...
GlobalPanel::GlobalPanel(juce::AudioProcessorValueTreeState& apvts)
{
    ...
    setRoundButton(filterLowPassButton, LOW_ID, "");
    setRoundButton(filterPeakButton, BAND_ID, "");
    setRoundButton(filterHighPassButton, HIGH_ID, "");
    ...
    filterLowPassButton.setComponentID("low_pass");
    filterPeakButton.setComponentID("band_pass");
    filterHighPassButton.setComponentID("high_pass");

    // 为 global switches 设置 ComponentID
    filterSwitch.setComponentID("flat_toggle");
    downsampleSwitch.setComponentID("flat_toggle");
